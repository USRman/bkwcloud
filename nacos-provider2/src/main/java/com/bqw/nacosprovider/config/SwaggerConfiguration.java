package com.bqw.nacosprovider.config;
...
@EnableSwagger2
@EnableKnife4j
//@EnableSwaggerBootstrapUI //已被 EnableKnife4j代替
@Import(BeanValidatorPluginsConfiguration.class)
public class SwaggerConfiguration {

    @Bean(value = "providerApi")
    @Order(value = 1)
    public Docket groupRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(groupApiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.bqw.nacosprovider.controller"))
